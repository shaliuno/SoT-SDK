...
void ABP_BountyRewardSkullItemInfo_Rare__C::UserConstructionScript()
{
	...
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_BountyRewardSkullItemInfo_Rare+.BP_BountyRewardSkullItemInfo_Rare+_C.UserConstructionScript"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_BountyRewardSkullItemInfo_Rare+.BP_BountyRewardSkullItemInfo_Rare+_C.ReceiveBeginPlay"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_BountyRewardSkullItemInfo_Rare+.BP_BountyRewardSkullItemInfo_Rare+_C.ExecuteUbergraph_BP_BountyRewardSkullItemInfo_Rare+"));}
