...
void ABP_DecalGlow_Longer_C::StartGlowEffect()
{
	...
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_DecalGlow_Longer.BP_DecalGlow_Longer_C.StartGlowEffect"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_DecalGlow_Longer.BP_DecalGlow_Longer_C.StartReaction"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_DecalGlow_Longer.BP_DecalGlow_Longer_C.StopReaction"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_DecalGlow_Longer.BP_DecalGlow_Longer_C.CollectDecalMaterials"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_DecalGlow_Longer.BP_DecalGlow_Longer_C.UserConstructionScript"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_DecalGlow_Longer.BP_DecalGlow_Longer_C.ReceiveBeginPlay"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_DecalGlow_Longer.BP_DecalGlow_Longer_C.ExecuteUbergraph_BP_DecalGlow_Longer"));}
