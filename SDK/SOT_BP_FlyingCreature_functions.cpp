...
void ABP_FlyingCreature_C::CreateCreature()
{
	...
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_FlyingCreature.BP_FlyingCreature_C.CreateCreature"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_FlyingCreature.BP_FlyingCreature_C.UserConstructionScript"));}
