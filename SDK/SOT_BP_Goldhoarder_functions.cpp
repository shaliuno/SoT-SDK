...
void ABP_Goldhoarder_C::UserConstructionScript()
{
	...
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_Goldhoarder.BP_Goldhoarder_C.UserConstructionScript"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_Goldhoarder.BP_Goldhoarder_C.ReceiveBeginPlay"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_Goldhoarder.BP_Goldhoarder_C.ExecuteUbergraph_BP_Goldhoarder"));}
