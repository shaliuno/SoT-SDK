...
void ABP_LightingZone_C::Update_Lighting_Zone()
{
	...
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_LightingZone.BP_LightingZone_C.Update Lighting Zone"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_LightingZone.BP_LightingZone_C.UserConstructionScript"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_LightingZone.BP_LightingZone_C.ReceiveBeginPlay"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_LightingZone.BP_LightingZone_C.ExecuteUbergraph_BP_LightingZone"));}
