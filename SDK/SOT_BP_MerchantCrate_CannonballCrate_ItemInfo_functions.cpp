...
void ABP_MerchantCrate_CannonballCrate_ItemInfo_C::UserConstructionScript()
{
	...
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_MerchantCrate_CannonballCrate_ItemInfo.BP_MerchantCrate_CannonballCrate_ItemInfo_C.UserConstructionScript"));}
