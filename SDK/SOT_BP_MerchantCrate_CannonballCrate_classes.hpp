...
class ABP_MerchantCrate_CannonballCrate_C : public AMerchantCrate
{
public:
	...
	{
		static UClass* ptr = 0;
		if(ptr == 0) { ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_MerchantCrate_CannonballCrate.BP_MerchantCrate_CannonballCrate_C")); }
		return ptr;
	}
