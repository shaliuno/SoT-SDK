...
void ABP_Merchant_C::UserConstructionScript()
{
	...
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_Merchant.BP_Merchant_C.UserConstructionScript"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_Merchant.BP_Merchant_C.PlayItemAnimation"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_Merchant.BP_Merchant_C.ExecuteUbergraph_BP_Merchant"));}
