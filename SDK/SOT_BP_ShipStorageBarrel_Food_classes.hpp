...
class ABP_ShipStorageBarrel_Food_C : public AShipStorageContainer
{
public:
	...
	{
		static UClass* ptr = 0;
		if(ptr == 0) { ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ShipStorageBarrel_Food.BP_ShipStorageBarrel_Food_C")); }
		return ptr;
	}
