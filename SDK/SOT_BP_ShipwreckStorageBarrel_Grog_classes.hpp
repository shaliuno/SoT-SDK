...
class ABP_ShipwreckStorageBarrel_Grog_C : public ATankardRefiller
{
public:
	...
	{
		static UClass* ptr = 0;
		if(ptr == 0) { ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ShipwreckStorageBarrel_Grog.BP_ShipwreckStorageBarrel_Grog_C")); }
		return ptr;
	}
