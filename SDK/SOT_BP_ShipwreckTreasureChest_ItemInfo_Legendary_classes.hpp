...
public:
	...
	{
		static UClass* ptr = 0;
		if(ptr == 0) { ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ShipwreckTreasureChest_ItemInfo_Legendary.BP_ShipwreckTreasureChest_ItemInfo_Legendary_C")); }
		return ptr;
	}
