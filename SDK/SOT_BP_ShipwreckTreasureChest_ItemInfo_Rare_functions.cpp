...
void ABP_ShipwreckTreasureChest_ItemInfo_Rare_C::UserConstructionScript()
{
	...
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_ShipwreckTreasureChest_ItemInfo_Rare.BP_ShipwreckTreasureChest_ItemInfo_Rare_C.UserConstructionScript"));}
