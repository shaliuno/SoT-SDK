...
void ABP_ShipwreckTreasureChest_Proxy_Common_C::UserConstructionScript()
{
	...
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_ShipwreckTreasureChest_Proxy_Common.BP_ShipwreckTreasureChest_Proxy_Common_C.UserConstructionScript"));}
