...
public:
	...
	class USkeletalMeshComponent*                      SkeletalMesh;                                             // 0x0520(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	{
		static UClass* ptr = 0;
		if(ptr == 0) { ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_Shopkeeper.BP_Shopkeeper_C")); }
		return ptr;
	}
