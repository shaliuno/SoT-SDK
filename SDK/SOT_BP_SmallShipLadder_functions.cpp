...
struct FDockableInfo ABP_SmallShipLadder_C::GetDockableInfo()
{
	...
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_SmallShipLadder.BP_SmallShipLadder_C.GetDockableInfo"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_SmallShipLadder.BP_SmallShipLadder_C.Setup Spline"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_SmallShipLadder.BP_SmallShipLadder_C.CanInteract"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_SmallShipLadder.BP_SmallShipLadder_C.UserConstructionScript"));}
