...
public:
	...
	class UStaticMeshComponent*                        Token_2;                                                  // 0x0588(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	class UStaticMeshComponent*                        Token_1;                                                  // 0x05A0(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	{
		static UClass* ptr = 0;
		if(ptr == 0) { ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_VotableCancelVoyage.BP_VotableCancelVoyage_C")); }
		return ptr;
	}
