...
public:
	...
	class UStaticMeshComponent*                        shp_flag_pennant_01_a;                                    // 0x0778(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)

	static UClass* StaticClass()
	{
		static UClass* ptr = 0;
		if(ptr == 0) { ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_large_mast_fore.BP_large_mast_fore_C")); }
		return ptr;
	}
