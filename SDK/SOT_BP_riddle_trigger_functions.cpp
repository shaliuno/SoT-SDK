...
void ABP_riddle_trigger_C::Destroy()
{
	...
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_riddle_trigger.BP_riddle_trigger_C.Destroy"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function BP_riddle_trigger.BP_riddle_trigger_C.UserConstructionScript"));}
