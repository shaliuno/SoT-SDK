...
public:
	...
	{
		static UClass* ptr = 0;
		if(ptr == 0) { ptr = UObject::FindClass(_xor_("Class GameLiveStreaming.GameLiveStreamingFunctionLibrary")); }
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = 0;
		if(ptr == 0) { ptr = UObject::FindClass(_xor_("Class GameLiveStreaming.QueryLiveStreamsCallbackProxy")); }
		return ptr;
	}
