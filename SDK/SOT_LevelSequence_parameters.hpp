...
struct ULevelSequencePlayer_CreateLevelSequencePlayer_Params
{
	...
	class ULevelSequence*                              LevelSequence;                                            // (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData) 0008
	struct FLevelSequencePlaybackSettings              Settings;                                                 // (CPF_Parm) 0010
	class ULevelSequencePlayer*                        ReturnValue;                                              // (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReturnParm, CPF_IsPlainOldData) 0018
};

// Function LevelSequence.LevelSequenceActor.SetSequence
struct ALevelSequenceActor_SetSequence_Params
{
	class ULevelSequence*                              InSequence;                                               // (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData) 0000
};
