...
public:
	...
	{
		static UClass* ptr = 0;
		if(ptr == 0) { ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass Proposal_CatchAll_AllAtOnce_Rank01Reward_002.Proposal_CatchAll_AllAtOnce_Rank01Reward_002_C")); }
		return ptr;
	}
