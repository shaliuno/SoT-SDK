...
public:
	...
	{
		static UClass* ptr = 0;
		if(ptr == 0) { ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass Proposal_CatchAll_Chapters_Rank06Reward_001.Proposal_CatchAll_Chapters_Rank06Reward_001_C")); }
		return ptr;
	}
