...
public:
	...
	{
		static UClass* ptr = 0;
		if(ptr == 0) { ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass Proposal_PirateLegend_CatchAll_Chapters_RankLegendaryReward_06.Proposal_PirateLegend_CatchAll_Chapters_RankLegendaryReward_06_C")); }
		return ptr;
	}
