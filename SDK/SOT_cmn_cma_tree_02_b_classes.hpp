...
public:
	...
	class UStaticMeshComponent*                        wsp_trunk_01_b;                                           // 0x0490(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)

	static UClass* StaticClass()
	{
		static UClass* ptr = 0;
		if(ptr == 0) { ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass cmn_cma_tree_02_b.cmn_cma_tree_02_b_C")); }
		return ptr;
	}
