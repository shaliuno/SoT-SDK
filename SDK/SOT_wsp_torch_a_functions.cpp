...
void Awsp_torch_a_C::UserConstructionScript()
{
	...
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function wsp_torch_a.wsp_torch_a_C.UserConstructionScript"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function wsp_torch_a.wsp_torch_a_C.ReceiveBeginPlay"));}
...
{
	static UFunction* fn = 0;
	if(fn == 0) { fn = UObject::FindObject<UFunction>(_xor_("Function wsp_torch_a.wsp_torch_a_C.ExecuteUbergraph_wsp_torch_a"));}
